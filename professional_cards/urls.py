...
urlpatterns = [
    ...
    path('p/<slug:slug>/action/', views.professional_primary_cta, name='primary_cta'),
    path('p/<slug:slug>/offering/<int:service_id>/', views.professional_offering_action, name='offering'),
