...
urlpatterns = [
    ...
    path('dashboard/accounts/', dashboard_accounts, name='dashboard_accounts'),
    path('dashboard/counter-payment/', dashboard_counter_payment, name='dashboard_counter_payment'),
    path('dashboard/library/', dashboard_library, name='dashboard_library'),
    path('dashboard/records/', dashboard_records, name='dashboard_records'),
    ...
    path('api/wallet/topup/', api_wallet_topup, name='api_wallet_topup'),
    path('api/wallet/pay/', api_wallet_pay, name='api_wallet_pay'),
    path('api/wallet/balance/<int:student_id>/', api_wallet_balance, name='api_wallet_balance'),
    path('api/wallet/transactions/<int:student_id>/', api_wallet_transactions, name='api_wallet_transactions'),
