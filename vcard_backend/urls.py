...
urlpatterns = [
    ...
    path('workspaces/', react_app, name='workspace_chooser'),
    ...
    path('dashboard/organizations/<int:organization_id>/club/', react_app, name='dashboard_club_workspace'),
    path('dashboard/organizations/<int:organization_id>/club/members/', react_app, name='dashboard_club_members'),
    path('dashboard/organizations/<int:organization_id>/club/profile-design/', react_app, name='dashboard_club_profile_design'),
    ...
    path('dashboard/card-operations/', react_app, name='dashboard_card_operations'),
    ...
    path('api/dashboard/platform-activity/', dashboard_platform_activity_api, name='dashboard_platform_activity_api'),
    path('api/dashboard/platform-reports/', dashboard_platform_reports_api, name='dashboard_platform_reports_api'),
    path('api/dashboard/card-batches/', react_api.card_batches_api, name='react_card_batches_api'),
    path('api/dashboard/card-batches/<int:batch_id>/', react_api.card_batch_detail_api, name='react_card_batch_detail_api'),
    path('api/dashboard/card-batch-profiles/', react_api.card_batch_profile_search_api, name='react_card_batch_profile_search_api'),
    path('api/dashboard/card-batches/<int:batch_id>/cards/', react_api.card_batch_cards_api, name='react_card_batch_cards_api'),
    path('api/dashboard/card-batches/<int:batch_id>/cards/<int:card_id>/', react_api.card_batch_card_detail_api, name='react_card_batch_card_detail_api'),
    ...
    path('api/session/workspace/', react_api.session_workspace_select_api, name='react_session_workspace_select_api'),
    ...
    path('api/dashboard/club-profile/', react_api.club_profile_settings_api, name='club_profile_settings_api'),
    path('api/dashboard/club-overview/', react_api.club_workspace_overview_api, name='club_workspace_overview_api'),
    path('api/dashboard/club-social-links/', react_api.club_social_links_api, name='club_social_links_api'),
    path('api/dashboard/club-social-links/<int:link_id>/', react_api.club_social_link_detail_api, name='club_social_link_detail_api'),
    path('api/dashboard/club-events/', react_api.club_events_api, name='club_events_api'),
    path('api/dashboard/club-events/<int:event_id>/', react_api.club_event_detail_api, name='club_event_detail_api'),
    path('api/dashboard/club-members/<int:student_id>/profile/', react_api.club_member_profile_api, name='club_member_profile_api'),
    path('api/dashboard/club-members/<int:student_id>/social-links/', react_api.club_member_social_links_api, name='club_member_social_links_api'),
    path('api/dashboard/club-members/<int:student_id>/social-links/<int:link_id>/', react_api.club_member_social_link_detail_api, name='club_member_social_link_detail_api'),
    path('api/club-members/<int:student_id>/', react_api.club_member_public_profile_api, name='club_member_public_profile_api'),
